...
import 'package:wechat_assets_picker/wechat_assets_picker.dart'; // Necesario para AssetEntityImage
...
class _SelectorFotosPropioState extends State<SelectorFotosPropio> {
  ...
  Future<void> _cargarFotos() async {
    ...
    // CRÍTICO: Definir orden explícito para evitar error en algunos Androids
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Stack(
                    fit: StackFit.expand,
                    children: [
                      // --- CORRECCIÓN: Usar AssetEntityImage para evitar el crash ---
                      AssetEntityImage(
                        asset,
                        isOriginal: false, // Carga miniatura, crucial para rendimiento
